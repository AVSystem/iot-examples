...
public class AirQualityUpdater implements Consumer<AirQuality> {
    ...
    public AirQualityUpdater(WeatherAndQualityService service, boolean shouldRandomizeData) {
    ...
    public void accept(AirQuality airQuality) {
        if (shouldRandomizeData) {
            ...
            WeatherAndQualityData data = service.getData();
            airQuality.setPm10(data.getPm10());
            airQuality.setPm25(data.getPm25());
        }
    }
}
